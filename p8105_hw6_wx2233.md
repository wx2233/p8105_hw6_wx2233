...
in terms of the cross-validated prediction error; use crossv\_mc and
...
```
    ...
    ## # A tibble: 2 x 3
    ##   quantity  estimate_mean estimate_sd
    ##   <chr>             <dbl>       <dbl>
    ## 1 r_squared         0.911     0.00870
    ## 2 logbeta01         2.01      0.0237
...
that the r square is high, the model is explainable. The mean of
log(beta0beta1) is 2.01, the sd of log(beta0beta1) is 0.024.

The r\_squared is right skewed.
