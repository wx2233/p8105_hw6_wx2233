...
``` r
## use t test
t_test_result_r_2 = t.test(weather_results$r_squared) 
t_test_result_log01 = t.test(weather_results$log_result) 
...
| quantity   | estimate\_mean | estimate\_sd |  cv\_lwr |   cv\_upr |
| :--------- | -------------: | -----------: | -------: | --------: |
